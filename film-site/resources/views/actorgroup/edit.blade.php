...
<div class="block mx-auto my-12 p-8 bg-gray w-1/3 border border-gray-200 rounded-lg shodow-lg">
    ...
    <form class="mt-4" method="POST" enctype="multipart/form-data" action="{{ route('actorgroup.update', $item->id) }}">
        @csrf
        ...
        p-2 my-2 focus:bg-white" placeholder="Actor" id="actor" name="actor" value="{{ $item->actor }}">
